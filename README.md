...
| RECEIVER | Required | str | The email address(es) that receive the paper list.  Multiple addresses are supported and can be separated by **semicolons (`;`)**, **commas (`,`)**, or **spaces**.  All listed addresses will receive the same daily email. Example: `abc@outlook.com;cde@qq.com 123@163.com,456@126.com` |abc@outlook.com;cde@qq.com 123@163.com,456@126.com |
